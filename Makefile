...
#    Updated: 2015/12/03 02:49:41 by sblancha         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJ = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	  ...
	  ft_tolower.o ft_toupper.o ft_strtrim.o ft_strsub.o ft_strsplit.o \
	  ft_strnew.o ft_strnequ.o ft_strmapi.o ft_strmap.o ft_strjoin.o \
